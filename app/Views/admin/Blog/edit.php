					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
                                ...
                                ?>
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?= base_url('dish2o_admin/blog/update') ?>" enctype="multipart/form-data">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="name" name="name" class="form-control" value="<?php echo $blogDetails['name']; ?>">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="short_description" name="short_description" class="form-control " value="<?php echo $blogDetails['short_description']; ?>">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<div class="x_content">
													...
													<textarea name="descr" id="descr" style="display:none;"><?php echo $blogDetails['content']; ?></textarea>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="video_url" name="video_url" class="form-control " value="<?php echo $blogDetails['video_url']; ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Cover Photo </label>
											<div class="col-md-6 col-sm-6 ">
												<?php if($blogDetails['photo']){ ?><img src="<?php echo base_url('dish2o_admin/blog/resource').'?filename='.$blogDetails['photo']; ?>" width="100px"/><?php } ?><BR/><BR/>
