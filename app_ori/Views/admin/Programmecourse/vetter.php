                            ...
                            <div class="x_content">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="existingmodule" role="tabpanel" aria-labelledby="existingmodule-tab">
                                        ...
                                        <form id="editorsmodal" data-parsley-validate class="form-horizontal form-label-left" method="post">
                                            <div class="modal-body">
...
<script>
   ...
   $(document).ready(function() {
      $(".editormodal").click(function() {
       var data= $("#editor-one").textContent;
       //alert(data);
        $("#pcu_id").val($(this).data('pcu_id'));
      });

      $("#editorsmodal").submit(function(e) {
        e.preventDefault(); // Prevent default form submission
       
          var formData = new FormData();
          formData.append('data', $("#editor-one").innerHTML);
          alert($("#editor-one").textContent);
