...
INSERT INTO `dsh2_module_video` (`id`, `module_id`, `video_id`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT INTO `dsh2_programme_course_unit` (`id`, `programme_course_id`, `unit_id`, `created_at`, `created_by`) VALUES
(1, 1, 1, '2023-12-21 11:26:42', 0),
(2, 1, 2, '2023-12-21 11:26:42', 0);
...
CREATE TABLE `dsh2_programme_course_unit_module` (
  `id` int(11) NOT NULL,
  `position` int(6) NOT NULL,
  `program_course_unit_id` int(11) DEFAULT NULL,
  `module_id` int(11) DEFAULT NULL,
  `created_by` int(3) UNSIGNED DEFAULT NULL,
  `updated_by` int(3) UNSIGNED DEFAULT NULL,
  `deleted_by` int(3) UNSIGNED DEFAULT NULL,
...
INSERT INTO `dsh2_programme_course_unit_module` (`id`, `position`, `program_course_unit_id`, `module_id`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 1, NULL, NULL, NULL, '2023-12-21 06:25:03', '2023-12-21 06:25:03', NULL),
(2, 2, 1, 2, NULL, NULL, NULL, '2023-12-21 06:25:03', '2023-12-21 06:25:03', NULL);
...
INSERT INTO `dsh2_unit` (`id`, `position`, `name`, `learning_objectives`, `is_active`, `is_archive`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'Data Collection and Presentation', NULL, 1, 0, NULL, NULL, NULL, '2023-12-21 05:56:00', '2023-12-21 05:56:00', NULL),
(2, 2, 'Measures of Central Tendency and Dispersion', NULL, 1, 0, NULL, NULL, NULL, '2023-12-21 05:56:00', '2023-12-21 05:56:00', NULL);
...
INSERT INTO `dsh2_video` (`id`, `user_id`, `video_url`, `language_id`, `transcript`, `is_active`, `is_archive`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'https://www.youtube.com/watch?v=4ILqym44W0A', 1, 'transcript', 'Y', 'N', NULL, NULL, NULL, '2023-12-21 07:27:08', '2023-12-21 07:27:08', NULL),
(2, 1, 'https://i.ytimg.com/vi/bATUwsh4mzU/maxresdefault.jpg', 2, NULL, 'Y', 'N', NULL, NULL, NULL, '2023-12-21 07:27:08', '2023-12-21 07:27:08', NULL);
